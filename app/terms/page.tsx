...
<section className="flex flex-col gap-3">
          ...
          <p className="m-0 text-[15px] leading-[1.6] text-muted-foreground">
            The Genome Computer Company sells a sequencing service and delivery of the
        ...
        <section className="flex flex-col gap-3">
          ...
          <p className="m-0 text-[15px] leading-[1.6] text-muted-foreground">
            ...
            United States. The Genome Computer Company is operated by Humankind Bio, Inc., a
